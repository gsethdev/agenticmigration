...
server = FastMCP(
    ...
    instructions=(
        ...
        "to Azure App Service, including Managed Instance on App Service.\n\n"
        ...
        "  6. recommend_target - recommend Managed Instance on App Service vs regular App Service\n"
        ...
        "  9. plan_deployment - plan App Service Plans (PV4 for Managed Instance)\n"
        ...
        "KEY CONSTRAINT: Managed Instance on App Service requires PV4 SKU with IsCustomMode=true. "
        "This is the ONLY valid Managed Instance configuration."
    ),
)
